...
public class Project implements Serializable {
    ...
    // 项目编号（编码长度为17位，实际为招标项目编号20位）
    // 1位行业门类字母码 + 6位行政区域代码 + 4位全国交易平台序列号 + 项目序列号的取值从000001-999999
    // "A" + "130100" + "1001" + "XXXXXX"
    @ApiModelProperty(value = "项目编号", required = true, position = 4)
    private String serialNo;

    @ApiModelProperty(value = "项目名称", required = true, position = 5)
    private String name;

    @ApiModelProperty(value = "采购单位uid", position = 5)
