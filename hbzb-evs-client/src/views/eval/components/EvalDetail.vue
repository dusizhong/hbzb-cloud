                ...
                <el-tab-pane v-for="tab in tabs" :label="tab.name" :name="tab.code">
                    <!-- <el-row :gutter="20">
                        <el-col :span="12" style="margin-bottom:10px">
                            <el-button type="primary" size="mini" v-on:click="onConfirm">提交</el-button>
                            <el-button type="primary" size="mini" v-on:click="onSubmit">汇总提交</el-button>
                        </el-col>
                        <el-col :span="12" align="right" style="font-size:14px">总分值：40分</el-col>
                    </el-row> -->
                    <el-table :header-cell-style="{background:'#eef1f6', color:'#606266'}" border stripe fit :data="tableData" v-loading="loading">
                        ...
                        <el-table-column v-for="(col,i) in tableCols" :key="col.id" :label="col.name" align="center" width="200">
                            ...
                            <template slot-scope="scope">
                                <el-input-number v-model="scope.row[col.code]" :precision="2" :step="0.1" :max="10" size="medium" style="width:160px"></el-input-number>
                            </template>
                        </el-table-column>
                        <el-table-column prop="result" label="汇总" align="center" width="100"></el-table-column>
                    </el-table>
                </el-tab-pane>
            </el-tabs>
