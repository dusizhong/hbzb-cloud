...
<script>
    export default {
        ...
        methods: {
            ...
            fetchData() {
                this.loading = true;
                this.$http.get('/tas/eval/member/list?sectionUid=' + this.section.uid).then((data) => {
                    this.tableData = data;
                    this.loading = false;
            ...
            addMember() {
                this.loading = true;
                this.$http.post('/tas/eval/member/create?sectionUid=' + this.section.uid + '&userUid=' + this.selectedUser.uid + '&name=' + this.selectedUser.realName + '&role=' + this.selectedUser.authorities + '&phone=' + this.selectedUser.phone).then((data) => {
                    this.loading = false;
                    this.fetchData();
                }).catch(() => this.loading = false);
