	...
	<div>
		<div class="container">
			...
			<el-collapse v-model="collapse">
				...
				<!-- 邀请函信息 -->
				<el-collapse-item title="邀请函信息" name="3">
					<template slot="title">
						<span style="font-size:15px"><b>邀请函信息</b></span>
					</template>
					<el-form :model="form" :rules="rules" ref="form" label-width="80px">
						...
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="回复截止时间" prop="replyDeadline">
									<el-date-picker v-model="form.replyDeadline" type="datetime" placeholder="请填写" value-format="yyyy-MM-dd HH:mm:ss" default-time="00:00:00" style="width:100%"></el-date-picker>
								</el-form-item>
							</el-col>
						</el-row>
						<el-row :gutter="20">
							<el-col :span="24">
								<el-form-item label="邀请函" prop="content">
				...
				<!-- 邀请记录 -->
				<el-collapse-item title="邀请记录" name="4">
					<template slot="title">
						<span style="font-size:15px"><b>邀请记录</b></span>
					</template>
			...
			<div style="margin-top:20px; text-align:center">
				...
				<el-button type="primary">发出邀请函</el-button>
			</div>
		</div>
