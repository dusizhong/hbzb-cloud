...
public class RWExcel {
    ...
    public ArrayList<List> ReadExcel2(int sheetNum) {
        ArrayList<List> list = new ArrayList<List>();
        try {
    ...
    public ArrayList<List> ReadAnotherExcel2(int anotherSheetNum){
        ArrayList<List> list = new ArrayList<List>();
        try {
            // 建需要读取的excel文件写入stream
	...
	public static void main(String[] args) {
		 ...
		 RWExcel excel = new RWExcel("D:\\11.xlsx", "D:\\22.xlsx");
		 ArrayList<List> list1 = excel.ReadExcel2(0);
		 ArrayList<List> list2 = excel.ReadAnotherExcel2(1);
		 for (List list : list1) {
