...
/**
 * Swagger配置
 * http://192.168.33.200:8000/api/v1/uaa/swagger-ui.html
 * * http://192.168.33.200:8000/api/v1/uaa/doc.html
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hbzb.cloud.tender"))
